...
unsigned int EntityIdentifier::m_iceBit				= 0x20;
unsigned int EntityIdentifier::m_waterBit			= 0x200;
...
unsigned int EntityIdentifier::IceBit()
{
	return m_iceBit;
}

unsigned int EntityIdentifier::WaterBit()
{
	return m_waterBit;
}
