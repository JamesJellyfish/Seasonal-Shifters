...
inline const int b2Body::GetEntityNumber() {
	return entityNumber;
}

inline const int b2Body::GetEntityType() {
	return entitytype;
}

inline void b2Body::SetEntityNumber(int EN) {
	entityNumber = EN;
}

inline void b2Body::SetEntityType(int ET) {
	entitytype = ET;
}
